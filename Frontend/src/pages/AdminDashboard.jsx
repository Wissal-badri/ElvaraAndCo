  ...
  if (authLoading)
    return (
      <div className="admin-page">
        <p style={{ color: "#888", margin: "auto" }}>Loading...</p>
      </div>
    );
                  ...
                  <tbody>
                    {products.map((p) => (
                      ...
                      >
                        ...
                        <td>
                          <span
                            className={`stock-badge ${p.stock > 0 ? "in-stock" : "no-stock"}`}
                          >
                            {p.stock}
                          </span>
                        </td>
                  ...
                  <div className="form-group full-width">
                    ...
                    <div className="sizes-grid">
                      {["XS", "S", "M", "L", "XL", "XXL"].map((size) => (
                        <label
                          key={size}
                          className={`size-checkbox ${selectedSizes.includes(size) ? "selected" : ""}`}
                        >
                          <input
                            type="checkbox"
